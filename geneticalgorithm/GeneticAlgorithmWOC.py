...
totalpoints,coordslist=load('../Random40.tsp')
...
def createPopulation(popsize):
    ...
    population.append(stheta)
    population.append(sr)
    # print(stheta)
    # print(distanceofRoute(stheta))
    # print(distanceofRoute(sr))
...
bestRoute = geneticAlgorithm(100, 30, 0.0005, 100000)
